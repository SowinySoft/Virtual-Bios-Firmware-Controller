...
\begin{tikzpicture}[
    ...
    component/.style={
        ...
        fill=white, minimum height=14mm, minimum width=28mm,
        drop shadow={shadow xshift=1pt, shadow yshift=-1pt, opacity=0.15}
    },
    storage/.style={
        draw, rounded corners=3pt, thick,
        fill=vbfcLightGray, minimum height=14mm, minimum width=24mm,
        drop shadow={shadow xshift=1pt, shadow yshift=-1pt, opacity=0.15}
    },
    interface/.style={
        draw, diamond, aspect=2, thick,
        fill=vbfcBlue!10, minimum height=10mm, minimum width=18mm,
        drop shadow={shadow xshift=1pt, shadow yshift=-1pt, opacity=0.15}
    },
