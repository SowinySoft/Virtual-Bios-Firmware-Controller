...
\node[fieldbox, minimum width=60mm, below=of fl2] (fl3) {Image Version (uint16, anti-rollback)};
\node[fieldbox, minimum width=60mm, below=of fl3] (fl4) {Payload Length (bytes, excludes header)};
\node[fieldbox, minimum width=60mm, below=of fl4] (fl5) {SHA-256(payload)};
\node[reservedbox, minimum width=60mm, below=of fl5] (fl6) {Public Key (ECDSA-P256, Phase B)};
\node[fieldbox, minimum width=60mm, below=of fl6] (fl7) {HMAC-SHA256(key, payload) (Phase A)};
\node[reservedbox, minimum width=60mm, below=of fl7] (fl8) {ECDSA Signature (Phase B)};
\node[fieldbox, minimum width=60mm, below=of fl8] (fl9) {Reserved / Zero Padding};
